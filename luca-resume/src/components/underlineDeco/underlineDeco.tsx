import React, { HTMLAttributes, PropsWithChildren, cloneElement, ReactElement } from 'react';
...
function UnderlineDeco(props: UnderlineProps) {
  ...
  return (
    <div className={`deco-container d-flex align-items-start ${className || ''}`} {...rest}>
      {childrenWithRef}
