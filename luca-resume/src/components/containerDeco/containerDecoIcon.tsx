...
type ContainerDecoIconProps = Omit<HTMLAttributes<HTMLDivElement>, "children"> & ContainerDecoIconBaseProps

export const ContainerDecoIcon = forwardRef<HTMLDivElement, ContainerDecoIconProps>((props, ref) => {
  const { icon } = props
  ...
  return (
    <div ref={ref} style={imgContainerStyle} className="container-deco-icon">
      <img ref={imgRef as any} className="container-deco-icon-image" src={icon} />
    </div>
  )
});
